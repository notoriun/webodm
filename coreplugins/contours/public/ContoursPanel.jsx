      ...
      content = (<div>
        ...
        <div className="row action-buttons">
          <div className="col-sm-3">
            {previewLayer ? <a title="Delete Preview" onClick={this.handleRemovePreview}>
          ...
          <div className="col-sm-9 text-right">
            ...
            <div className="btn-group">
              ...
              <ul className="dropdown-menu  pull-right">
                <li>
                  <a onClick={this.handleExport("GPKG")}>
                    <i className="fa fa-globe fa-fw"></i> GeoPackage (.GPKG)
                  </a>
                </li>
                <li>
                  <a onClick={this.handleExport("DXF")}>
                    <i className="far fa-file fa-fw"></i> AutoCAD (.DXF)
                  </a>
                </li>
                <li>
                  <a onClick={this.handleExport("GeoJSON")}>
                    <i className="fa fa-code fa-fw"></i> GeoJSON (.JSON)
                  </a>
                </li>
                <li>
                  <a onClick={this.handleExport("ESRI Shapefile")}>
