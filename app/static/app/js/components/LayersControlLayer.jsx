    ...
    render() {
        ...
        return (<div className="layers-control-layer">
            <div className="layer-control-title">
                ...
                <a title={meta.name} className="layer-label" onClick={this.handleLayerClick}><i className={"layer-icon " + (meta.icon || "fa fa-vector-square fa-fw")}></i><div className="layer-title">{meta.name}</div></a> <a className="layer-action" onClick={this.handleZoomToClick}><i title={_("Zoom To")} className="fa fa-expand"></i></a>
            </div>
