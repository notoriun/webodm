        ...
        {!this.state.presetActionPerforming ?
          <div className="btn-group presets-dropdown">
            ...
            <ul className="dropdown-menu">
              <li>
                <a onClick={this.handleEditPreset}><i className="fa fa-sliders-h"></i> {_("Edit")}</a>
              </li>
              <li className="divider"></li>

              {this.state.selectedPreset.id !== -1 ?
                <li>
                  <a onClick={this.handleDuplicateSavePreset}><i className="fa fa-copy"></i> {_("Duplicate")}</a>
                </li>
                :
                <li>
                  <a onClick={this.handleDuplicateSavePreset}><i className="fa fa-save"></i> {_("Save")}</a>
                </li>
              }
              <li className={this.state.selectedPreset.system ? "disabled" : ""}>
                <a onClick={this.handleDeletePreset}><i className="fa fa-trash"></i> {_("Delete")}</a>
              </li>
            </ul>
          </div>
