  ...
  render() {
    ...
    const items = [
      <pre key="console" className={`console prettyprint
        ...
        ref={this.setRef}
      ><a onClick={this.exitFullscreen} className="exit-fullscreen btn btn-sm btn-primary" title={_("Toggle Fullscreen")}>
    ...
    if (this.props.showConsoleButtons) {
      items.push(<div key="buttons" className="console-buttons">
        <a onClick={() => this.downloadTxt()} className="btn btn-sm btn-primary" title={_("Download To File")}>
          <i className="fa fa-download"></i>
        </a>
        <a onClick={this.enterFullscreen} className="btn btn-sm btn-primary" title={_("Toggle Fullscreen")}>
